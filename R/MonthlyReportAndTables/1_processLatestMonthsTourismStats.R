...
#### Table 8: Proportion of visitors by country of usual residence and purpose of visit ####
...
for(travel_type_column in columns_of_interest){
  ...
  travel_type_percentages <- UsualResByPOV_percentage [,travel_type_column_as_percentage, drop = TRUE]
...
write.csv(TourismFINAL, 'TourismFINAL.csv')
